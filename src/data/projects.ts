export const projects = [
  {
    title: "Klass Stores – Online Supermarket (Pakistan)",
    description: "Developed a high-performance e-commerce platform for Klass Stores, digitizing a large-scale physical grocery inventory for the Pakistani market. The focus was on managing 3,000+ SKUs while maintaining a lightweight, lightning-fast user experience.",
    keySolutions: [
      "Massive Inventory Management: Engineered a deep-nested category system to organize thousands of products into an intuitive, easy-to-navigate structure.",
      "Custom 'Quick-Shop' UX: Integrated AJAX-based 'Quick Add' functionality and an instant cart update feature, allowing users to buy multiple items rapidly.",
  ...
  {
    title: "Pearls Store – Electronics & Gadget Hub (Pakistan)",
    description: "Developed a high-performance e-commerce storefront for Pearls Store, a specialized retailer of modern electronics, gadgets, and mobile accessories. The goal was to build a tech-centric platform that handles complex product specifications while providing a fast, secure shopping experience.",
    keySolutions: [
      "Technical Product Architecture: Designed custom product layouts to highlight detailed technical specifications, warranty information, and compatibility charts.",
      "Smart Tech Search: Implemented a high-speed AJAX search with advanced filtering for brands, price ranges, and technical features.",
      "High-Efficiency Checkout: Optimized the checkout process for higher-value electronic purchases, integrating COD and secure local payment gateways.",
  ...
  {
    title: "Khatoon-e-Jannat – Home Textiles & Fashion (Pakistan)",
    description: "Developed a comprehensive e-commerce platform for Khatoon-e-Jannat, a specialized retailer in the Pakistani textile market. The project focuses on a dual-category catalog featuring premium Bedding and Suiting, designed to provide a high-end shopping experience.",
    keySolutions: [
      "Dual-Niche Catalog Architecture: Engineered a seamless navigation system that allows users to toggle between Home Textiles and Fashion.",
      "Textile-Focused Visuals: Implemented high-resolution zoom functionality.",
      "Localized Logistics for Pakistan: Integrated regional shipping calculators and Cash on Delivery (COD) payment modules.",
  ...
  },
  {
    ...
    keySolutions: [
      "Euro-Market Strategy: Designed a high-end, professional UI tailored to attract the Irish and broader European business markets.",
      "Automation Workflow Showcase: Built dedicated interactive sections to demonstrate core competencies in n8n workflow automation.",
