...
export function Navbar() {
  ...
  return (
    <>
      ...
      >
        <div className="w-full max-w-7xl bg-background/70 backdrop-blur-lg border border-white/10 shadow-lg shadow-black/20 rounded-full px-4 md:px-6 py-2 flex items-center justify-between">
