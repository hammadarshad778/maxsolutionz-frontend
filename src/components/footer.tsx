...
export function Footer() {
  const socialLinks = [
    { Icon: Instagram, href: "https://www.instagram.com/max_solutionz/" },
    { Icon: Facebook, href: "https://www.facebook.com/profile.php?id=61586502062725" },
    { Icon: Linkedin, href: "https://www.linkedin.com/company/maxsolutionz/" },
    { Icon: Whatsapp, href: "https://whatsapp.com/channel/0029Vb7tygiK0IBbfmgO2P01" },
  ];
          ...
          >
            ...
            <div className="flex gap-4 pt-2">
              {socialLinks.map(({ Icon, href }, i) => (
                <Link key={i} href={href} target="_blank" rel="noopener noreferrer" className="h-10 w-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-muted-foreground hover:text-primary hover:bg-primary/10 hover:border-primary/30 transition-all hover:scale-110">
